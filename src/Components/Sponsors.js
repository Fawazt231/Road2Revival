            ...
            <div>
                <Col span={24}>
                    <div className="container" style={{ height: 250 }}>
                        <img id="gif" alt="example" src={'https://images.axios.com/9sl24UIJzwQwR02qK2Hn6XcC6yI=/fit-in/1920x1920/2020/04/28/1588095225695.gif'} />
                        <div
                            className="program"
                    ...
                    <Row>
                        ...
                        <Col xs={24} sm={12} md={12} lg={8}>
                            <Card
                                ...
                                style={{ margin: 20, height: cardHeightRow1 }}
                            >
                                <img alt="example" src={helping} style={{ maxWidth: '70%', height: '40%' }} />
                                <Divider dashed>Description</Divider>
